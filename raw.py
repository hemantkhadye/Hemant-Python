...
#    print(PgNo)
    if (PgNo == 1):
        url = "https://www.qoo10.sg/gmkt.inc/Category/Default.aspx?gdlc_cd=100000001&gdmc_cd=200000001&gdsc_cd=300000001"
        Qloc = url.index("?", 0, len(url))
#       print(url)
        url = "https://www.qoo10.sg/gmkt.inc/Search/SearchResultAjaxTemplate.aspx" + url[Qloc:] + "&curPage=" + str(PgNo) + "&pageSize=120&ajax_search_type=C&___cache_expire___=" + str(epoch)
#        print(url)
    if(PgNo == 1):
